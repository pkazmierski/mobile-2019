...
import pl.amazonaws.amplify.generated.graphql.CreateCommentMutation;
import pl.amazonaws.amplify.generated.graphql.CreatePublicEventMutation;
import pl.amazonaws.amplify.generated.graphql.CreateQuestionMutation;
import pl.amazonaws.amplify.generated.graphql.CreateUserEventMutation;
import pl.amazonaws.amplify.generated.graphql.CreateUserMutation;
import pl.amazonaws.amplify.generated.graphql.CreateStudyOfferMutation;
import pl.amazonaws.amplify.generated.graphql.DeleteCommentMutation;
import pl.amazonaws.amplify.generated.graphql.DeleteUserEventMutation;
import pl.amazonaws.amplify.generated.graphql.DeleteStudyOfferMutation;
import pl.amazonaws.amplify.generated.graphql.GetPublicEventQuery;
import pl.amazonaws.amplify.generated.graphql.GetUserQuery;
import pl.amazonaws.amplify.generated.graphql.ListCommentsQuery;
import pl.amazonaws.amplify.generated.graphql.ListContactsQuery;
import pl.amazonaws.amplify.generated.graphql.ListFilesQuery;
import pl.amazonaws.amplify.generated.graphql.ListPublicEventsQuery;
import pl.amazonaws.amplify.generated.graphql.ListQuestionsQuery;
import pl.amazonaws.amplify.generated.graphql.ListStudyOffersQuery;
import pl.amazonaws.amplify.generated.graphql.ListUserEventsQuery;
import pl.amazonaws.amplify.generated.graphql.UpdateCommentMutation;
import pl.amazonaws.amplify.generated.graphql.UpdateQuestionMutation;
import pl.amazonaws.amplify.generated.graphql.UpdateStudyOfferMutation;
import pl.amazonaws.amplify.generated.graphql.UpdateUserEventMutation;
import pl.amazonaws.amplify.generated.graphql.UpdateUserMutation;
...
public class AppSyncDb implements DataProvider {
    ...
    public void getQuestions(Runnable onSuccess, Runnable onFailure) {
        ...
        Logic.appSyncClient.query(ListQuestionsQuery.builder()
                .build())
    ...
    public void addQuestion(Runnable onSuccess, Runnable onFailure, Question question) {
        if (question.getId().equals("")) { //new local (unpushed) question
            ...
            Logic.appSyncClient.mutate(CreateQuestionMutation.builder().input(createQuestionInput).build())
    ...
    private void changeCommentCount(@Nonnull Question question, @Nonnull int change) {
        ...
        Logic.appSyncClient.mutate(UpdateQuestionMutation.builder().input(updateQuestionInput).build())
    ...
    public void bookmarkQuestion(Runnable onSuccess, Runnable onFailure, Question question, boolean add) {
        ...
        Logic.appSyncClient.mutate(UpdateUserMutation.builder().input(updateUserDataInput).build())
    ...
    public void getComments(Runnable onSuccess, Runnable onFailure, Question question) {
        ...
        Logic.appSyncClient.query(ListCommentsQuery.builder()
    ...
    public void addComment(Runnable onSuccess, Runnable onFailure, Comment comment) {
        if (comment.getId().equals("")) { //new local (unpushed) comment
            ...
            CreateCommentInput createCommentInput = CreateCommentInput.builder()
                    ...
                    .createdAt(isoDateTime)
                    .creator(AWSMobileClient.getInstance().getUsername())
                    .build();

            Logic.appSyncClient.mutate(CreateCommentMutation.builder().input(createCommentInput).build())
    ...
    public void removeComment(Runnable onSuccess, Runnable onFailure, Comment comment) {
        ...
        Logic.appSyncClient.mutate(DeleteCommentMutation.builder().input(deleteCommentInput).build())
    ...
    public void modifyComment(Runnable onSuccess, Runnable onFailure, Comment comment) {
        ...
        Logic.appSyncClient.mutate(UpdateCommentMutation.builder().input(updateCommentInput).build())
...
//                        DataStore.getUserData().setActiveOffersIds(new ArrayList<>());
        ...
        Logic.appSyncClient.query(GetUserQuery.builder()
                .id(DataStore.getUserData().getLogin())
                .build())
                .responseFetcher(AppSyncResponseFetchers.CACHE_AND_NETWORK)
...
//                            DataStore.getUserData().setActiveOffersIds(new ArrayList<>());
    ...
    public void createNewUserData(Runnable onSuccess, Runnable onFailure) {
        ...
        Logic.appSyncClient.mutate(CreateUserMutation.builder().input(createCommentInput).build())
                .enqueue(createCommentCallback);
    }
...
//                    Log.d(TAG, "getUserEvents list: " + response.data().listUserEvents().items().toString() + "; nextToken: " + tokenExists);
        ...
        Logic.appSyncClient.query(ListUserEventsQuery.builder()
                .build())
                .responseFetcher(AppSyncResponseFetchers.CACHE_AND_NETWORK)
    ...
    public void getPublicEvent(Runnable onSuccess, Runnable onFailure, String eventId, ChecklistEvent checklistEvent) {
        ...
        Logic.appSyncClient.query(GetPublicEventQuery.builder()
                .id(eventId)
                .build())
                .responseFetcher(AppSyncResponseFetchers.CACHE_AND_NETWORK)
...
//                    Log.d(TAG, "getPublicEvents list: " + response.data().listPublicEvents().items().toString() + "; nextToken: " + tokenExists);
        ...
        Logic.appSyncClient.query(ListPublicEventsQuery.builder()
                .build())
                .responseFetcher(AppSyncResponseFetchers.CACHE_AND_NETWORK)
    ...
    public void updateSingleUserEvent(Runnable onSuccess, Runnable onFailure, ChecklistEvent checklistEvent) {
        ...
        Logic.appSyncClient.mutate(UpdateUserEventMutation.builder().input(updateUserEventInput).build())
    ...
    public void createSingleUserEvent(Runnable onSuccess, Runnable onFailure, ChecklistEvent checklistEvent) {
        if (checklistEvent.getId().equals("")) { //new, uninitialized event
            ...
            Logic.appSyncClient.mutate(CreateUserEventMutation.builder().input(createUserEventInput).build())
    ...
    public void removeSingleUserEvent(Runnable onSuccess, Runnable onFailure, ChecklistEvent checklistEvent) {
        if (!checklistEvent.getId().equals("") || !checklistEvent.isUserCreated()) { //don't try to delete events with unknown id
            ...
            Logic.appSyncClient.mutate(DeleteUserEventMutation.builder().input(createUserEventInput).build())
    ...
    public void setEventsOrder(Runnable onSuccess, Runnable onFailure, HashMap<String, Integer> eventsOrder) {
        ...
        Logic.appSyncClient.mutate(UpdateUserMutation.builder().input(updateUserInput).build())
                .enqueue(createUserEventMutationCallback);
    }
    ...
    public void addPublicEvent(Runnable onSuccess, Runnable onFailure, ChecklistEvent checklistEvent) {
        if (checklistEvent.getId().equals("")) { //new, uninitialized event
            ...
            Logic.appSyncClient.mutate(CreatePublicEventMutation.builder().input(createPublicEventInput).build())
    ...
    public void getContacts(Runnable onSuccess, Runnable onFailure) {
        ...
        Logic.appSyncClient.query(ListContactsQuery.builder()
                .build())
                .responseFetcher(AppSyncResponseFetchers.CACHE_AND_NETWORK)
    ...
    public void getFiles(Runnable onSuccess, Runnable onFailure) {
        ...
        Logic.appSyncClient.query(ListFilesQuery.builder()
                .build())
                .responseFetcher(AppSyncResponseFetchers.CACHE_AND_NETWORK)
    ...
    public void getStudyOffers(Runnable onSuccess, Runnable onFailure) {
        ...
        Logic.appSyncClient.query(ListStudyOffersQuery.builder()
                .build())
                .responseFetcher(AppSyncResponseFetchers.CACHE_AND_NETWORK)
    ...
    public void addStudyOffer(Runnable onSuccess, Runnable onFailure, @Nonnull StudyOffer studyOffer) {
        if (studyOffer.getId().equals("")) {
            ...
            Logic.appSyncClient.mutate(CreateStudyOfferMutation.builder().input(createStudyOfferInput).build())
    ...
    public void modifyStudyOffer(Runnable onSuccess, Runnable onFailure, StudyOffer studyOffer) {
        ...
        Logic.appSyncClient.mutate(UpdateStudyOfferMutation.builder().input(updateStudyOfferInput).build())
    ...
    public void removeStudyOffer(Runnable onSuccess, Runnable onFailure, StudyOffer studyOffer) {
        ...
        Logic.appSyncClient.mutate(DeleteStudyOfferMutation.builder().input(deleteStudyOfferInput).build())
